...
import org.dist.queue.{ByteBufferMessageSet, IteratorTemplate, KafkaException, Logging, Message, MessageAndOffset, MessageSet, Utils}
...
class FileMessageSet private[queue](val file: File,
