...
private[queue] class LogManager(val config: Config,
  ...
  private val logRetentionMsMap = Map[String, Long]()
  private val logRollMsMap = Map[String, Long]()
  private val logRollDefaultIntervalMs: Long = 1000L * 60 * 60 * config.logRollHours
  private val logCleanupIntervalMs = 1000L * 60 * config.logCleanupIntervalMins
  private val logCleanupDefaultAgeMs: Long = 1000L * 60 * 60 * config.logRetentionHours
