...
import org.dist.simplekafka.utils.timer.{SystemTimer, Timer, TimerTask}
...
abstract class DelayedOperation(override val delayMs: Long,
  ...
  // Visible for testing
  private val lock: Lock = lockOpt.getOrElse(new ReentrantLock)
